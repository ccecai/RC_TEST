...
#include "oledfont.h"
#include "delay.h"
extern int mode,PWM,CurrentPosition;
...
void oled_first_show(void)
{
	...
	OLED_ShowString(0,3,"MODE:",12);	
}

void oled_show(void)
{
	
		OLED_ShowNumber(25,3,mode,2,12);
		
		
		OLED_ShowNumber(25,1,Encoder_Left,2,12);
		
		OLED_ShowNumber(85,1,Encoder_Right,2,12);
		
		OLED_ShowNumber(25,2,Target_A,2,12);
